...
> 前置：`docs/soul/SOUL-MEMORY.md`（v1.1 已归档，本层承接其可复用部分）
>
...
dsh-evolve v0.4.2（已装入，冒烟全绿，见 `docs/integrations/EVOLVE-SMOKE.md`）提供了**机制**：跨会话记忆、零 token 召回、审批门、技能固化生命周期。但它缺两样东西，正是本层补的：
