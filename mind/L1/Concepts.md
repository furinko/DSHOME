...
> 版本：1.1 | 2026-09-04 | 语义层落地：概念 → 唯一权威源 的**单一契约**；todo/progress 权威源明确为「体系主线档（跨设备）」；版本日期校正（原错标 09-06）
...
---
_版本：1.1 | 2026-09-04 | 语义层落地：todo / progress / suggestion / memory / skill 唯一权威源_
