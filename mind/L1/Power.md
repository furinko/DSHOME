...
> 版本：1.7 | 2026-09-05 | 三筛改四筛：加可移植筛（无盘符/绝对路径，出厂跨设备约束）；余同 1.6
...
> 3. **通用筛**（"否"→ 私有）：换台干净设备/给别人，这份方法论还能照做吗？依赖本机独有环境（特定目录/软件/账号）或个人工作习惯 → 私有；跨项目可复用的"怎么做某类事"逻辑 → 出厂候选。
...
_版本：1.7 | 2026-09-05 | v1.6（三筛法）→ 四筛法：加可移植筛（出厂无盘符/绝对路径硬约束）_
