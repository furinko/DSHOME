...
contract:
  ...
  inputs: [项目/任务关键词]
  outputs: [注入上下文（进度+待办+相关 L3+教训+用户偏好+人设卡）, 一次 refresh/update]
...
---
_版本：1.0.3 | 2026-09-06 | outputs/正文对齐注入层 v2.5：L0 纪律改「AGENTS.md 全文注入（正文=注入源）」，去掉过时的「L0/HUB/Wisdom 决策规则摘要」描述；余同 1.0.2_
