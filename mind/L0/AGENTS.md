...
- 🟡 **收工提醒** — 对话自然结束或完成一轮修改，主动问「需要收工吗？」，触发收工闭环（`mind\L1\Power.md` §五 9 步，**含第9步收工自省**——用 §六 自省问题集逐条问自己，必走不靠"想起来"）。
...
_版本：2.1 | 2026-09-06 | L0 权威版（唯一）：语义层落地（Concepts 契约）+ 自我修改硬流程 + 权威版声明；纪律收敛：细则下沉 Power §九。根版已于 2026-09-04 退役删除。_
